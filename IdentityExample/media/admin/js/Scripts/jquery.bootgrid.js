...
;(function ($, window, undefined)
{
        ...
        firstHeadRow.children().each(function ()
        {
            var $this = $(this),
                ...
                column = {
                    ...
                    sortable: !(data.sortable === true), // default: true
    ...
    */
    ...
    function renderPagination()
    {
        if (this.options.navigation !== 0)
        {
            ...
            if (this.rowCount !== -1 && paginationItems.length > 0)
            {
                ...
                //renderPaginationItem.call(this, pagination, "first", "<i class=\"fa  fa-angle-double-right\"></i>", "first")
                //    ._bgEnableAria(current > 1);
                renderPaginationItem.call(this, pagination, "prev", "<i class=\"fa fa-angle-right\"></i>", "prev")
                    ._bgEnableAria(current > 1);
                ...
                renderPaginationItem.call(this, pagination, "next", "<i class=\"fa fa-angle-left\"></i>", "next")
                    ._bgEnableAria(totalPages > current);
                //renderPaginationItem.call(this, pagination, "last", "<i class=\"fa fa-angle-double-left\"></i>", "last")
                //    ._bgEnableAria(totalPages > current);
    ...
    Grid.defaults = {
        ...
        //rowCount: null, // rows per page int or array of int (-1 represents "All")
        ...
        css: {
            ...
            right: "text-right",
            search: "search pull-left", // must be a unique class name or constellation of class names within the header and footer
        ...
        labels: {
            all: "همه",
            infos: "نمایش {{ctx.start}} تا {{ctx.end}} آیتم",
            loading: "در حال بارگزاری",
            noResults: "هیچ آیتمی پیدا نشد...",
            refresh: "بازسازی",
            search: " جستجو کنید..."
        },
        ...
        templates: {
            ...
            footer: "<div id=\"{{ctx.id}}\" class=\"{{css.footer}}\"><div class=\"row\"><p class=\"{{css.pagination}}\"></p><div class=\"btn btn-primary  pull-left\"><p class=\"{{css.infos}}\"></p></div></div></div>",
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
    

            //header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-6 actionBar pull-left\"><p class=\"{{css.actions}} \"></p> <p class=\"{{css.search}} \"></p></div></div></div>",
            ...
            search: "<div class=\"{{css.search}}\"><span class=\"{{css.icon}} fa input-group-addon cur-pointer fa-close \"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div>",
            //search: "",

            //select: "<input type=\"checkbox\"  class=\"i-checks\" name=\"input[]\">"
         
            select: "<input id=\"checkbox-s\" name=\"select\" type=\"{{ctx.type}}\" class=\"select-box table-checkbox\" value=\"{{ctx.value}}\" /> <label for=\"checkbox-s\"></label>"
        }
    };
